...
HeroUnit.schema = {
  ...
  getDefaultProps: () => ({
    ...
    text: "We are a Nhật Hào web development company committed to deliver great products on time. We love to understand our customers' needs and exceed expectations.",
    badge: [
      {
        text: 'high tech',
